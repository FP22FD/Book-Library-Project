...
> enable Gogle Books Api in your project
...
per titolo:
https://www.googleapis.com/books/v1/volumes?key=...&q=intitle:crochet&maxResults=40&orderBy=newest&printType=books&projection=full

per subject:
https://www.googleapis.com/books/v1/volumes?key=...&q=subject:crochet&maxResults=40&orderBy=newest&printType=books&projection=full
...
thumbnailUrl
previewUrl
googleBooksId ("lLNLEAAAQBAJ")

AIzaSyDb6qQNrSdCG50FcdSrDkvgtqvfidu7UIk